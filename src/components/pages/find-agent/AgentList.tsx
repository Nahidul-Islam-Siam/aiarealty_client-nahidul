    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-12">
          <p className="text-red-600 text-lg">Error fetching agents data.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Featured Agents</h1>
      ...
      <Link href={`/find-agent/${agent?.id}`} key={agent?.id}>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-shrink-0">
                  <div className="relative w-16 h-16 rounded-lg overflow-hidden bg-gray-100">
                    <Image
                      src={agent?.profile?.Image?.[0]?.url || `https://randomuser.me/api/portraits/men/${Math.floor(Math.random() * 100) || "/placeholder.svg"}.jpg`}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <Badge
                      variant={agent?.userStatus === "ACTIVE" ? "default" : "destructive"}
                      className={`ml-2 ${agent?.userStatus === "ACTIVE" ? "bg-green-100 text-green-800 hover:bg-green-100" : "bg-red-100 text-red-800 hover:bg-red-100"}`}
                    >
                      {agent?.userStatus === "ACTIVE" ? "Active" : "Inactive"}
                    </Badge>
                  </div>
